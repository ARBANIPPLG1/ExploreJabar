...
<<<<<<< HEAD
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col transition-all duration-300 hover:scale-103 hover:shadow-2xl">
                <div class="relative">
                    ...
                    <button class="absolute top-3 right-3 p-2 bg-white/80 backdrop-blur-sm rounded-full text-red-500 shadow-md hover:scale-110 transition-transform duration-200">
...
<<<<<<< HEAD
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col transition-all duration-300 hover:scale-103 hover:shadow-2xl">
                <div class="relative">
                    <img class="w-full h-48 object-cover" src="img/gede-pangrango.jpg" alt="Gede Pangrango">
                    <button class="absolute top-3 right-3 p-2 bg-white/80 backdrop-blur-sm rounded-full text-red-500 shadow-md hover:scale-110 transition-transform duration-200">
                        <i class="far fa-heart"></i>
                    </button>
                    <span class="absolute bottom-3 left-3 px-3 py-1 bg-blue-600 text-white text-xs font-semibold rounded-full">Mountain</span>
...
<<<<<<< HEAD
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col transition-all duration-300 hover:scale-103 hover:shadow-2xl">
                <div class="relative">
                    <img class="w-full h-48 object-cover" src="img/Pantai Pelabuhan Ratu.jpeg" alt="Pelabuhan Ratu">
                    <button class="absolute top-3 right-3 p-2 bg-white/80 backdrop-blur-sm rounded-full text-red-500 shadow-md hover:scale-110 transition-transform duration-200">
                        <i class="far fa-heart"></i>
                    </button>
        ...
        <div class="md:col-span-1"> 
            ...
            <div class="space-y-4 text-gray-600">
                ...
                <div class="flex items-start">
                    ...
                    <p class="text-sm">Jl. Aminah Syukur No.82, Sungai Pinang Luar, Kec. Samarinda Kota, Kota Samarinda, Kalimantan Timur 75113</p>
                </div>
                
                <div class="flex items-start">
                    <i class="fas fa-phone-alt text-lg text-blue-600 mr-3 mt-0.5"></i>
                    <div class="text-sm">
                        <p>(555) 111-2345</p>
                        <p>(555) 222-6789</p>
                    </div>
                ...
                <div class="flex items-start">
                    <i class="fas fa-envelope text-lg text-blue-600 mr-3 mt-0.5"></i>
                    <div class="text-sm">
